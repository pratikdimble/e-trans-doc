...
This README.md **links all docs pages, shows architecture, tech stack, and screenshots**, just like professional GitHub portfolios such as [pratikdimble/eaas-app-doc](https://github.com/pratikdimble/eaas-app-doc).
